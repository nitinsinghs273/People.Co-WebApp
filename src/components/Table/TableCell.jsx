...
const TableCell = ({ data, className = "", propBackgroundColor }) => {
  ...
  return (
    <>
      ...
      >
        <section
          className="flex flex-row items-center justify-between w-full border-l-0 border-r-0 border-b-[1px] border-t-0 border-gray-200 border-solid "
          onClick={() => handleCellClick(data.id)}
        >
          <div className="flex items-center justify-start pl-4 gap-2 flex-grow flex-shrink">
            <div
              className="h-10 w-10 rounded-full bg-gray-300 bg-cover"
              style={{ backgroundImage: "url('/avatar9@3x.png')" }}
            />
            <div
              className="text-gray-600 min-w-[48px]"
              style={{ width: "80%" }}
            >
          ...
          <div className="text-gray-600 flex items-center justify-start gap-3 flex-grow flex-shrink">
          ...
          <div className="text-gray-600 flex items-center flex-grow flex-shrink">
            {data.role}
          </div>
