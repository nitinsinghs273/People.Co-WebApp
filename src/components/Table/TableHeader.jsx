...
const TableHeader = ({ className = "" }) => {
  return (
    <div
      className={`flex flex-row items-center justify-between w-full border-0 flex-grow flex-shrink ${className}`}
    >
      <div className="flex items-center flex-grow flex-shrink pl-4 gap-3 w-1/4 sm:w-1/5">
